...
class Hsdhjgvjhcvsd: ObservableObject {
    func pageDidLoad() {
            fsduguf = false
        }
...
struct Bvgdcs: View {
    ...
    @ObservedObject var nsdhvg: Hsdhjgvjhcvsd
    ...
    init(uRLRequest: URLRequest, webViewStateModel: Hsdhjgvjhcvsd) {
        self.sdfgdfxvc = uRLRequest
        self.nsdhvg = webViewStateModel
         
    }
    
    init(url: URL, webViewStateModel: Hsdhjgvjhcvsd) {
...
struct Nbxcnjvb : UIViewRepresentable {
    ...
    @ObservedObject var twergdf: Hsdhjgvjhcvsd
  ...
  @State private var hgdfhvajhdfg: WKWebView?
    ...
    init(hwgvfbdsfbvweghjb: Hsdhjgvjhcvsd,
    ...
    func makeUIView(context: Context) -> WKWebView  {
        ...
        @ObservedObject var webViewStateModel: Hsdhjgvjhcvsd
    ...
    final class Coordinator: NSObject {
        ...
        var bheyewuhvviuehv: Hsdhjgvjhcvsd
        let action: ((_ navigationAction: Bvgdcs.NavigationAction) -> Void)?
        
        init(parent: Nbxcnjvb, action: ((_ navigationAction: Bvgdcs.NavigationAction) -> Void)?, webViewStateModel: Hsdhjgvjhcvsd) {
            self.parent = parent
            self.action = action
